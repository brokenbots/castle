...
package overlordv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/brokenbots/overlord/shared/pb/overlord/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	OverseerServiceName = "overlord.v1.OverseerService"
)
...
const (
	...
	// RPC.
	OverseerServiceRegisterProcedure = "/overlord.v1.OverseerService/Register"
	// OverseerServiceHeartbeatProcedure is the fully-qualified name of the OverseerService's Heartbeat
	// RPC.
	OverseerServiceHeartbeatProcedure = "/overlord.v1.OverseerService/Heartbeat"
	...
	OverseerServiceControlProcedure = "/overlord.v1.OverseerService/Control"
)

// OverseerServiceClient is a client for the overlord.v1.OverseerService service.
...
// NewOverseerServiceClient constructs a client for the overlord.v1.OverseerService service. By
...
func NewOverseerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OverseerServiceClient {
	...
	overseerServiceMethods := v1.File_overlord_v1_overseer_proto.Services().ByName("OverseerService").Methods()
...
// Register calls overlord.v1.OverseerService.Register.
...
// Heartbeat calls overlord.v1.OverseerService.Heartbeat.
...
// Control calls overlord.v1.OverseerService.Control.
...
// OverseerServiceHandler is an implementation of the overlord.v1.OverseerService service.
...
func NewOverseerServiceHandler(svc OverseerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/overlord.v1.OverseerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOverseerServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.OverseerService.Register is not implemented"))
}
...
func (UnimplementedOverseerServiceHandler) Heartbeat(context.Context, *connect.Request[v1.HeartbeatRequest]) (*connect.Response[v1.HeartbeatResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.OverseerService.Heartbeat is not implemented"))
}
...
func (UnimplementedOverseerServiceHandler) SubmitEvents(context.Context, *connect.BidiStream[v1.Envelope, v1.Ack]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.OverseerService.SubmitEvents is not implemented"))
}
...
func (UnimplementedOverseerServiceHandler) Control(context.Context, *connect.Request[v1.ControlSubscribeRequest], *connect.ServerStream[v1.ControlMessage]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.OverseerService.Control is not implemented"))
}
