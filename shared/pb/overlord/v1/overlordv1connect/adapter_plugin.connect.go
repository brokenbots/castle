...
const (
	...
	// RPC.
	AdapterPluginServiceInfoProcedure = "/overlord.v1.AdapterPluginService/Info"
	// AdapterPluginServiceOpenSessionProcedure is the fully-qualified name of the
	// AdapterPluginService's OpenSession RPC.
	AdapterPluginServiceOpenSessionProcedure = "/overlord.v1.AdapterPluginService/OpenSession"
	// AdapterPluginServiceExecuteProcedure is the fully-qualified name of the AdapterPluginService's
	// Execute RPC.
	AdapterPluginServiceExecuteProcedure = "/overlord.v1.AdapterPluginService/Execute"
	// AdapterPluginServicePermitProcedure is the fully-qualified name of the AdapterPluginService's
	// Permit RPC.
	AdapterPluginServicePermitProcedure = "/overlord.v1.AdapterPluginService/Permit"
	// AdapterPluginServiceCloseSessionProcedure is the fully-qualified name of the
	// AdapterPluginService's CloseSession RPC.
	AdapterPluginServiceCloseSessionProcedure = "/overlord.v1.AdapterPluginService/CloseSession"
)

// AdapterPluginServiceClient is a client for the overlord.v1.AdapterPluginService service.
...
// NewAdapterPluginServiceClient constructs a client for the overlord.v1.AdapterPluginService
...
func NewAdapterPluginServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AdapterPluginServiceClient {
	...
	adapterPluginServiceMethods := v1.File_overlord_v1_adapter_plugin_proto.Services().ByName("AdapterPluginService").Methods()
...
// Info calls overlord.v1.AdapterPluginService.Info.
...
// OpenSession calls overlord.v1.AdapterPluginService.OpenSession.
...
// Execute calls overlord.v1.AdapterPluginService.Execute.
...
// Permit calls overlord.v1.AdapterPluginService.Permit.
...
// CloseSession calls overlord.v1.AdapterPluginService.CloseSession.
...
// AdapterPluginServiceHandler is an implementation of the overlord.v1.AdapterPluginService service.
...
func NewAdapterPluginServiceHandler(svc AdapterPluginServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/overlord.v1.AdapterPluginService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAdapterPluginServiceHandler) Info(context.Context, *connect.Request[v1.InfoRequest]) (*connect.Response[v1.InfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.AdapterPluginService.Info is not implemented"))
}
...
func (UnimplementedAdapterPluginServiceHandler) OpenSession(context.Context, *connect.Request[v1.OpenSessionRequest]) (*connect.Response[v1.OpenSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.AdapterPluginService.OpenSession is not implemented"))
}
...
func (UnimplementedAdapterPluginServiceHandler) Execute(context.Context, *connect.Request[v1.ExecuteRequest], *connect.ServerStream[v1.ExecuteEvent]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.AdapterPluginService.Execute is not implemented"))
}
...
func (UnimplementedAdapterPluginServiceHandler) Permit(context.Context, *connect.Request[v1.PermitRequest]) (*connect.Response[v1.PermitResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.AdapterPluginService.Permit is not implemented"))
}
...
func (UnimplementedAdapterPluginServiceHandler) CloseSession(context.Context, *connect.Request[v1.CloseSessionRequest]) (*connect.Response[v1.CloseSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("overlord.v1.AdapterPluginService.CloseSession is not implemented"))
}
