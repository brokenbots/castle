...
export class RegisterRequest extends Message<RegisterRequest> {
  ...
  static readonly typeName = "criteria.v1.RegisterRequest";
...
export class RegisterResponse extends Message<RegisterResponse> {
   ...
   *
   * @generated from field: map<string, string> bootstrap_credentials = 3;
   */
  bootstrapCredentials: { [key: string]: string } = {};
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.RegisterResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "criteria_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "bootstrap_credentials", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
  ]);
...
export class HeartbeatRequest extends Message<HeartbeatRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.HeartbeatRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "criteria_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class HeartbeatResponse extends Message<HeartbeatResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.HeartbeatResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class CreateRunRequest extends Message<CreateRunRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.CreateRunRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "criteria_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class Run extends Message<Run> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.Run";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "criteria_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class ReattachRunRequest extends Message<ReattachRunRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ReattachRunRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "criteria_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class ReattachRunResponse extends Message<ReattachRunResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ReattachRunResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Ack extends Message<Ack> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.Ack";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class ControlSubscribeRequest extends Message<ControlSubscribeRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ControlSubscribeRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "criteria_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class ControlMessage extends Message<ControlMessage> {
  ...
  command: {
     ...
     * CRI-60
     *
     * @generated from field: criteria.v1.WorkflowAssignment workflow_assignment = 5;
     */
     ...
     * CRI-74
     *
     * @generated from field: criteria.v1.PauseRun pause_run = 6;
     */
    value: PauseRun;
    case: "pauseRun";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ControlMessage";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "workflow_assignment", kind: "message", T: WorkflowAssignment, oneof: "command" },
    { no: 6, name: "pause_run", kind: "message", T: PauseRun, oneof: "command" },
  ]);
 ...
 *
 * @generated from message criteria.v1.WorkflowAssignment
 */
export class WorkflowAssignment extends Message<WorkflowAssignment> {
  /**
   * @generated from field: string run_id = 1;
   */
  runId = "";
   ...
   *
   * @generated from field: string workflow_source = 3;
   */
  workflowSource = "";
   ...
   *
   * @generated from field: string lockfile_source = 5;
   */
  lockfileSource = "";

  constructor(data?: PartialMessage<WorkflowAssignment>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.WorkflowAssignment";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "workflow_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "workflow_source", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "labels", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
    { no: 5, name: "lockfile_source", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): WorkflowAssignment {
    return new WorkflowAssignment().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): WorkflowAssignment {
    return new WorkflowAssignment().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): WorkflowAssignment {
    return new WorkflowAssignment().fromJsonString(jsonString, options);
  }

  static equals(a: WorkflowAssignment | PlainMessage<WorkflowAssignment> | undefined, b: WorkflowAssignment | PlainMessage<WorkflowAssignment> | undefined): boolean {
    return proto3.util.equals(WorkflowAssignment, a, b);
  }
}
...
export class RunCancel extends Message<RunCancel> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.RunCancel";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "reason", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class AgentPrompt extends Message<AgentPrompt> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.AgentPrompt";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class ControlReady extends Message<ControlReady> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ControlReady";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
export class ResumeRun extends Message<ResumeRun> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ResumeRun";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class ResumeRequest extends Message<ResumeRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ResumeRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "run_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "signal", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "payload", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
...
export class ResumeResponse extends Message<ResumeResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "criteria.v1.ResumeResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
